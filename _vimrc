" Make sure you use $HOME instead of ~, seems a bit buggy.
" Also clone the repo correctly git clone
" https://github.com/VundleVim/Vundle.vim.git $HOME/vimfiles/bundle/Vundle.vim
set path+=**
set shellslash
set wildmenu
